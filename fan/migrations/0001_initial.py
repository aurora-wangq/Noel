# Generated by Django 4.2.1 on 2023-07-20 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_level', models.IntegerField(default=0, verbose_name='文章排序内部运算基准,非必要不修改')),
                ('is_top', models.IntegerField(default=0, verbose_name='文章显示优先级,值大则优先级高,尽量不超过10')),
